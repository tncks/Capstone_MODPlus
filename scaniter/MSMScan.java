...
final class ScanContext {
    ...
    public ScanContext(double precursorTolerance, double precursorAccuracy, double gapTolerance, double gapAccuracy, double nonModifiedDelta, int maxNoOfC13,
                       double maxPeptideMass, double fragmentTolerance, int maxPTMPerPeptide
    ) {
    ...
    public void setMaxPTMPerPeptide(int maxPTMPerPeptide) {
        this.maxPTMPerPeptide = maxPTMPerPeptide;
    }
}
//
...
// Some consideration
// comment
/* Static Final Field: tolerance still depends on Constants - this should also be moved to the context.
 *  Finish moving all Constants dependencies into the context. */