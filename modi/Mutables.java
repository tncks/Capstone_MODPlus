...
public class Mutables {
    ...
    //->
    // TODO: Getters and setters for the instance fields


    // TODO: make constructor properly
    public Mutables() {
        // Initialize with default values if needed for each thread
    }
...
//    }
    ...
    public static void printGlobalMutables() {
        ...
        System.out.println("nonModifiedDelta: " + nonModifiedDelta);*/ // 필요 시 주석 해제 하고 작업
        System.out.println("*****************************");
        System.out.println("*****************************");
    }
/*임시비활(하지만 곧 적용할 코드임)
